...
const TIP = {
	...
	storyLine: { name: "storyLine", title: "情节卡", content: "为了推送情节的发展，在续写之时都需要抽取一张情节卡或关键卡，并续写卡片相关的内容。例如抽到了 狗血 卡，那么无论情节此时如何很单纯很不做作，都需要以狗血为基调编写剧情，如果抽到了 火腿 卡，那么续写的内容就要包含次关键词，并承上启下。" }
}
